...
@JsonTest
@Import({JsonConfig.class, DummyClientObjectMapperFactory.class})
class TodoResponseJsonTest {

    private final ObjectMapper objectMapper;

    public TodoResponseJsonTest(@Autowired final DummyClientObjectMapperFactory dummyClientObjectMapperFactory) {
        this.objectMapper = dummyClientObjectMapperFactory.createDummyClientObjectMapper();
    }
